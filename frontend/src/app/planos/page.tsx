        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1 text-black">
            <div className="bg-white rounded-lg shadow-sm p-6 sticky top-24">
              ...
              <div className="space-y-6">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Cobertura Médica Mínima</label>
                  <select
          ...
          <div className="lg:col-span-3">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
              <div className="flex items-center space-x-4">
                <span className="text-sm text-gray-600">{mockPlans.length} planos encontrados</span>
                          ...
                          <div>
                            ...
                            <div className="flex items-center space-x-1 mt-1">
                              <div className="flex items-center">
                                {[...Array(5)].map((_, i) => (
                                  <Star key={i} className={`h-4 w-4 ${i < Math.floor(plan.avaliacoes) ? 'text-yellow-400 fill-current' : 'text-gray-300'}`} />
                                ))}
                              </div>
                      ...
                      <div className="lg:w-64 text-center lg:text-right">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex space-x-2">
                            ...
                            >
                              <GitCompare className="h-4 w-4" />
                              <span className="text-sm">{selectedPlans.includes(plan.id) ? 'Selecionado' : 'Comparar'}</span>
                            </button>
        ...
        <div className={`grid gap-4`} style={{ gridTemplateColumns: `220px repeat(${getSelectedPlans().length}, minmax(260px,1fr))` }}>
          ...
          <div className="min-w-[220px]">
            ...
            <button
              ...
              onClick={() => alert('Mock: enviar comparação por e-mail')}
            >
              <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current"><path d="M2 6l10 7 10-7v12H2z"/><path d="M2 6l10 7 10-7H2z" className="fill-none"/></svg>
            ...
            <div key={plan.id} className="border rounded-lg">
              <div className="p-4">
                ...
                <button
                  ...
                  onClick={() => alert(`Mock: comprar ${plan.plano}`)}
                >
                  Comprar
                </button>
              </div>
      ...
      <div className="px-6 pb-6 mt-6 overflow-auto">
        {(() => {
          ...
          getSelectedPlans().forEach((p) =>
            (benefitsByPlan[p.id] ?? []).forEach((b) => rowsSet.add(b.titulo))
          );
