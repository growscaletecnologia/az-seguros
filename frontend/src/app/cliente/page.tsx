												...
												<div className="flex items-start justify-between">
													<div className="flex-1">
														...
														<p className="text-gray-600 mb-2">
															{policy.seguradora} • Nº {policy.numero}
														</p>
									...
									<div className="flex items-start space-x-3">
										...
										<div>
											<p className="text-sm text-blue-800">
												Para alterar seus dados pessoais, entre em contato
												com nosso suporte através do telefone
												<strong> 0800 123 4567</strong> ou email{" "}
												<strong>suporte@seguroviagem.com</strong>
											</p>
										</div>
									</div>
								</div>
				...
				<div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
					<div className="bg-white rounded-lg max-w-md w-full p-6">
						...
						<p className="text-gray-600 mb-6">
							...
							<strong>{selectedPolicy.numero}</strong>? Esta ação não pode ser
							desfeita.
						</p>
