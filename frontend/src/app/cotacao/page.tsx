...
export default function CotacaoPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.viagemBrasil) newErrors.viagemBrasil = 'Confirme que a viagem inicia no Brasil';
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1  text-black md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      />
                      {errors.dataIda && (
                        <p className="text-red-500 text-sm mt-1">{errors.dataIda}</p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                          errors.dataVolta ? 'border-red-500' : 'border-gray-300'
                        }`}
                      />
                      {errors.dataVolta && (
                        <p className="text-red-500 text-sm mt-1">{errors.dataVolta}</p>
                      )}
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      {errors.viagemBrasil && (
                        <p className="text-red-500 text-sm mt-1">{errors.viagemBrasil}</p>
                      )}
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Garantimos o melhor preço do mercado</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Atendimento especializado sempre</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Transações 100% protegidas</p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-blue-700">ajuda@seguroviagem.com</span>
                      </div>
                    </div>
                  </div>
                </div>
