              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{quotationData.dataIda} - {quotationData.dataVolta}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{quotationData.viajantes} pessoas</p>
                  </div>
                </div>
                <div className="flex items-center space-x-2">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              {couponApplied && (
                <div className="mt-3 flex items-center space-x-2 text-green-600">
                  ...
                  <span className="text-sm">Cupom aplicado com sucesso! 10% de desconto</span>
                </div>
              )}
            </div>
                ...
                <label className="flex items-center p-4 border rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                  ...
                  <div className="ml-3 flex-1 flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-sm text-gray-600">R$ {(totals.subtotal * 0.05).toFixed(2)} de economia</p>
                    </div>
                  </div>
                </label>
                ...
                <label className="flex items-center p-4 border rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                  ...
                  <div className="ml-3 flex-1 flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-sm text-gray-600">R$ {(totals.total / 12).toFixed(2)}/mês</p>
                    </div>
                  </div>
                </label>
                ...
                <div className="mt-6 space-y-4">
                  ...
                  <div>
                    ...
                    <select className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                      <option>1x de R$ {totals.total.toFixed(2)} sem juros</option>
                      <option>2x de R$ {(totals.total / 2).toFixed(2)} sem juros</option>
                      <option>3x de R$ {(totals.total / 3).toFixed(2)} sem juros</option>
                      <option>6x de R$ {(totals.total / 6).toFixed(2)} sem juros</option>
                      <option>12x de R$ {(totals.total / 12).toFixed(2)} sem juros</option>
                    </select>
                  </div>
                </div>
              )}
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 sticky top-24">
              ...
              <div className="border-b pb-4 mb-4">
                <div className="flex items-start justify-between mb-2">
                  <div>
                    <h4 className="font-medium text-gray-900">{selectedPlan.plano}</h4>
                    <p className="text-sm text-gray-600">{selectedPlan.seguradora}</p>
                  </div>
                  <p className="font-medium">R$ {selectedPlan.preco.toFixed(2)}</p>
                </div>
                <p className="text-sm text-gray-600">
                  {quotationData.viajantes} viajante(s) × R$ {selectedPlan.preco.toFixed(2)}
                </p>
              </div>

              {/* Coberturas */}
              <div className="border-b pb-4 mb-4">
                <h4 className="font-medium text-gray-900 mb-2">Coberturas Incluídas</h4>
                <div className="space-y-1 text-sm text-gray-600">
                  <p>• Cobertura Médica: USD {selectedPlan.coberturaMedica.toLocaleString()}</p>
                  <p>• Bagagem: USD {selectedPlan.coberturaBagagem.toLocaleString()}</p>
                  <p>• Cancelamento: USD {selectedPlan.coberturaCancelamento.toLocaleString()}</p>
