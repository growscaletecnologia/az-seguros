      ...
      <div className="bg-white p-6 rounded-lg shadow mb-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
          ...
          <div className="bg-blue-50 p-3 rounded">
            ...
            <p className="text-xl font-bold text-blue-800">R$ {totalVendas.toFixed(2)}</p>
          </div>
        </div>
      </div>
            ...
            <tbody>
              {pedidosFiltrados.map((pedido) => (
                <tr key={pedido.id} className="border-t hover:bg-gray-50">
                  <td className="px-4 py-2 font-mono text-sm">{pedido.numeroPedido}</td>
                  ...
                  <td className="px-4 py-2 font-semibold">R$ {pedido.valor.toFixed(2)}</td>
                  <td className="px-4 py-2">
                    <span className={`px-2 py-1 text-xs rounded ${getStatusColor(pedido.status)}`}>
                      {pedido.status}
                    </span>
                  </td>
