		...
		<Card className="mx-10 my-1">
			<CardHeader>
				...
				<CardDescription>
					...
					{isNew ? "criar um novo" : "editar o"} perfil
				</CardDescription>
			</CardHeader>
				...
				<form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
					...
					<div className="space-y-4">
						{userFunctions.map((userFunction) => {
							...
							const currentActions = watchUserActions[index]?.actions || "0000";

							return (
								<div
									key={userFunction.id}
									className="border border-gray-200 dark:border-gray-800 rounded-lg p-4 bg-gray-50 dark:bg-gray-900"
								>
									<div className="font-medium text-lg mb-4">
										{userFunction.displayName}
									</div>
														...
														render={() => (
															<div className="relative">
																<input
																	...
																	checked={currentActions[actionIndex] === "1"}
																	onChange={() => {
