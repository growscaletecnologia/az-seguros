...
const ConteudosPage = () => {
  ...
  const salvarEdicao = () => {
    if (editandoConteudo) {
      ...
      setConteudos(conteudos.map(c => c.id === editandoConteudo.id ? conteudoAtualizado : c));
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                value={editandoConteudo ? editandoConteudo.titulo : novoConteudo.titulo}
                onChange={(e) => {
                  if (editandoConteudo) {
                    setEditandoConteudo({ ...editandoConteudo, titulo: e.target.value });
                  } else {
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => {
                  const tipo = e.target.value as 'pagina' | 'banner' | 'faq' | 'termo';
                  if (editandoConteudo) {
          ...
          <div>
            ...
            <textarea
              ...
              value={editandoConteudo ? editandoConteudo.conteudo : novoConteudo.conteudo}
              onChange={(e) => {
                if (editandoConteudo) {
                  setEditandoConteudo({ ...editandoConteudo, conteudo: e.target.value });
                } else {
          ...
          <div className="flex space-x-2">
            <button
              ...
              disabled={!(editandoConteudo ? editandoConteudo.titulo && editandoConteudo.conteudo : novoConteudo.titulo && novoConteudo.conteudo)}
            >
              ...
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  <div className="flex items-center space-x-3 mb-2">
                    ...
                    <span className={`px-2 py-1 text-xs rounded ${getTipoColor(conteudo.tipo)}`}>
                      {conteudo.tipo}
                    </span>
