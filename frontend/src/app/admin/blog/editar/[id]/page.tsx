...
import { postsService, Post, UpdatePostDTO, PostCategory, PostTag } from "@/services/posts.service";
    ...
    const loadData = async () => {
      try {
        ...
        const [postData, categoriesData, tagsData] = await Promise.all([
          postsService.getPostById(params.id),
        ...
        alert("Erro ao carregar o post. Verifique se o ID é válido.");
                          ...
                          <Button 
                            ...
                            onClick={async () => {
                              try {
                                ...
                                alert("Funcionalidade para definir imagem principal será implementada em breve");
                              } catch (error) {
                        ...
                        <Button 
                          ...
                          onClick={async () => {
                            if (confirm("Tem certeza que deseja remover esta imagem?")) {
                              try {
                                await postsService.removeMedia(post.id, media.id);
