            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl lg:text-2xl text-blue-100">
                  Compare preços, encontre o melhor seguro de viagem e contrate em minutos. 
              ...
              <div className="relative z-10 bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium mb-2">Volta</label>
                      <input 
                        type="date" 
                        className="w-full px-4 py-3 rounded-lg bg-white/20 border border-white/30 text-white focus:outline-none focus:ring-2 focus:ring-yellow-400"
                      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Somos a plataforma líder em seguros de viagem no Brasil, com mais de 1 milhão de clientes satisfeitos.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center relative">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Preencha os dados</h3>
              <p className="text-gray-600 mb-6">
                Informe seu destino, datas da viagem e dados pessoais em nosso formulário simples e rápido.
              </p>
            ...
            <div className="text-center relative">
              ...
              <p className="text-gray-600 mb-6">
                Veja as melhores opções de seguradoras, compare coberturas e preços lado a lado.
              </p>
              <div className="bg-gray-100 rounded-lg p-4">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Finalize em minutos</h3>
              <p className="text-gray-600 mb-6">
                Escolha seu plano, efetue o pagamento e receba sua apólice por email instantaneamente.
              </p>
              <div className="bg-gray-100 rounded-lg p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg p-6 shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                &quot;Excelente atendimento! Tive um problema médico na Europa e fui atendido rapidamente. 
                Recomendo para todos os viajantes.&quot;
              </p>
            ...
            <div className="bg-white rounded-lg p-6 shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                &quot;Processo super fácil e rápido. Comparei vários planos e encontrei o melhor preço. 
                Viajei tranquilo sabendo que estava protegido.&quot;
              </p>
              <div className="flex items-center">
            ...
            <div className="bg-white rounded-lg p-6 shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                &quot;Suporte 24h realmente funciona! Precisei de ajuda durante a madrugada e fui atendida 
                imediatamente. Empresa confiável!&quot;
              </p>
              <div className="flex items-center">
                <div className="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center mr-3">
