...
export const rolesService = {
  ...
  assignPermissions: async (
    ...
    const response = await api.post(`/roles/${roleId}/permissions`, assignPermissionsDto)
    return response.data
  },
   ...
   */
  updateGranularPermissions: async (roleId: number, data: any): Promise<Role> => {
    const response = await api.post(`/roles/${roleId}/granular-permissions`, data)
    return response.data
  },
}
...
export const userRbacService = {
   ...
   */
  assignRoles: async (userId: string, assignRolesDto: AssignRolesDto): Promise<any> => {
  ...
  assignPermissions: async (
    ...
    const response = await api.post(`/users/${userId}/permissions`, assignPermissionsDto)
    return response.data
  },
   ...
   */
  removePermissions: async (userId: string, permissionIds: number[]): Promise<any> => {
