...
export const mockProducts: Product[] = [
  {
    ...
    detalhes: [
      ...
      { id: 'despesa_medica_total', label: 'Despesa Médica Hospitalar Total', value: 'USD 150.000' },
      { id: 'despesa_medica_hospitalar', label: 'Despesa Médica Hospitalar', value: 'USD 150.000' },
      { id: 'cobertura_esportes', label: 'Cobertura Médica para Prática de Esportes', value: 'USD 10.000' },
      { id: 'cobertura_gestante', label: 'Cobertura Médica para Gestante', value: 'USD 30.000' },
  ...
  },
  {
    ...
    detalhes: [
      { id: 'emissao_viagem', label: 'Permite emissão em viagem?', value: 'SIM, VERIFICAR CARÊNCIA PARA O INÍCIO DA VIAGEM' },
      { id: 'validade_geografica', label: 'Validade Geográfica', value: 'INTERNACIONAL EXCETO EUA E CANADÁ' },
      { id: 'franquia_dmh', label: 'Franquia de DMH', value: 'NÃO' },
      { id: 'despesa_medica_total', label: 'Despesa Médica Hospitalar Total', value: 'USD 60.000' },
      { id: 'despesa_medica_hospitalar', label: 'Despesa Médica Hospitalar', value: 'USD 60.000' },
      { id: 'cobertura_esportes', label: 'Cobertura Médica para Prática de Esportes', value: 'DENTRO DMH' },
      { id: 'cobertura_gestante', label: 'Cobertura Médica para Gestante', value: 'DENTRO DMH - ATÉ 28 SEMANAS' },
