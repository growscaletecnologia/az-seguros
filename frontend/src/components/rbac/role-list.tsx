      ...
      {selectedRole && (
        <Dialog open={isPermissionsOpen} onOpenChange={setIsPermissionsOpen}>
          <DialogContent className="sm:max-w-[700px]">
            <DialogHeader>
              <DialogTitle>Permissões do Papel: {selectedRole.name}</DialogTitle>
            </DialogHeader>
            <Tabs defaultValue="granular">
              <TabsList className="mb-4">
                <TabsTrigger value="granular">Permissões por Página</TabsTrigger>
                <TabsTrigger value="detailed">Permissões Detalhadas</TabsTrigger>
              </TabsList>
