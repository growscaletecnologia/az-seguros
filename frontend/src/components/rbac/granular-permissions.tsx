 ...
 */
export function GranularPermissions({ roleId, onSuccess }: GranularPermissionsProps) {
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <RadioGroup 
                      ...
                      onValueChange={(value) => 
                        handlePermissionChange(index, 'canRead', value === "true")
                      }
                      className="flex flex-col space-y-1"
                    >
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="true" id={`read-yes-${resource.id}`} />
                        <Label htmlFor={`read-yes-${resource.id}`}>Sim</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="false" id={`read-no-${resource.id}`} />
                  ...
                  <div className="space-y-2">
                    ...
                    <RadioGroup
                      ...
                      onValueChange={(value) =>
                        handlePermissionChange(index, 'canCreate', value === "true")
                      }
                      className="flex flex-col space-y-1"
                    >
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="true" id={`create-yes-${resource.id}`} />
                        <Label htmlFor={`create-yes-${resource.id}`}>Sim</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="false" id={`create-no-${resource.id}`} />
                  ...
                  <div className="space-y-2">
                    ...
                    <RadioGroup
                      ...
                      onValueChange={(value) =>
                        handlePermissionChange(index, 'canUpdate', value === "true")
                      }
                      className="flex flex-col space-y-1"
                    >
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="true" id={`update-yes-${resource.id}`} />
                        <Label htmlFor={`update-yes-${resource.id}`}>Sim</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="false" id={`update-no-${resource.id}`} />
                  ...
                  <div className="space-y-2">
                    ...
                    <RadioGroup
                      ...
                      onValueChange={(value) =>
                        handlePermissionChange(index, 'canDelete', value === "true")
                      }
                      className="flex flex-col space-y-1"
                    >
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="true" id={`delete-yes-${resource.id}`} />
                        <Label htmlFor={`delete-yes-${resource.id}`}>Sim</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="false" id={`delete-no-${resource.id}`} />
