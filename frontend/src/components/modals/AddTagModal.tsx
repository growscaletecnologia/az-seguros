...
import { type CreateTagDTO, tagsService } from "@/services/tags.service";
...
const tagSchema = z.object({
	...
	slug: z
		...
		.refine((slug) => isValidSlug(slug), {
			message:
				"Slug deve conter apenas letras minúsculas, números e hífens, sem espaços ou acentos",
		}),
							...
							render={({ field }) => (
								<FormItem>
									...
									<p className="text-sm text-muted-foreground">
										O slug é gerado automaticamente baseado no nome, mas pode
										ser editado.
									</p>
								</FormItem>
							)}
